...
def apply_reverse_mapping_transform(transformed_blocks):
    ...
    for block in transformed_blocks:
        ...
        for index, value in enumerate(col_sum):
            ...
            # msb_val = msb_dict[index]
            # pred_2_arr = [i for i in range(index) if msb_dict[i] == msb_val]
            # if pred_2_arr is not None and len(pred_2_arr) > 0:
            #     print('101010', lsb_dict[pred_2_arr[0]])
            lsb_nibble = lsb_nibble_pred_1
            lsb_dict[index] = lsb_nibble
            # print(index, lsb_nibble)
            nibble_index = None
        arr = []
        for i in range(16):
...
def combine_blocks_into_image(blocks, image_shape):
    ...
    # combined_image_height = num_blocks_rows * num_blocks
    # combined_image_width = num_blocks_cols * num_blocks
...
# print(transformed_first_half)
print('transformed_first_half')
print(len(transformed_first_half))
print(len(transformed_first_half[0]))
print(len(transformed_first_half[0][0]))
# print(len(np.array(transformed_first_half).flatten()))
...
# print(len(original_first_half))
# print(len(original_first_half[0]))
# print(len(original_first_half[0][0]))
# print(original_first_half)
